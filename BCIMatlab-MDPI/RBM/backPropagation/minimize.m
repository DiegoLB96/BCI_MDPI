function [X, fX, i] = minimize(X, f, length, reactFunct, varargin)
...
[f0 df0] = feval(f, X, reactFunct, varargin{:}); % get function value and gradient
fX = f0;
  ...
  while 1                             % keep extrapolating as long as necessary
    ...
    while ~success && M > 0
      try
        ...
        [f3 df3] = feval(f, X+x3*s, reactFunct, varargin{:});
